...
export function MobileNav() {
  ...
  return (
    <div className="sm:hidden">
      ...
      <div
        className={cn(
          'fixed inset-y-0 left-0 w-72 bg-white z-50 transform transition-transform duration-200 ease-in-out shadow-xl',
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t bg-white">
          <button
            ...
            className="flex items-center gap-3 w-full px-3 py-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 transition-colors min-h-[44px]"
          >
